...
DDNS_install() {
    ...
    case $ddns_choose_for_all in
        1) wget --quiet --show-progress -O /mnt/ddns/DDNS.sh https://raw.githubusercontent.com/Jimmyzxk/LinuxScripts/main/AIO/Configs/ddns/dnspod.sh ;;
    esac
...
http_server(){
    ...
    cd /mnt/gohttpserver
    wget --quiet --show-progress -O /mnt/gohttpserver/gohttpserver.tar.gz https://raw.githubusercontent.com/Jimmyzxk/LinuxScripts/main/AIO/Configs/gohttpserver/gohttpserver_1.1.4_linux_amd64.tar.gz
