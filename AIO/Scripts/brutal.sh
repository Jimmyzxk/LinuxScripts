...
install_nginx() {
  ...
  wget -q -O /etc/nginx/conf.d/default.conf https://raw.githubusercontent.com/Jimmyzxk/LinuxScripts/main/AIO/Configs/brutal/nginx/brutal_nginx_config.conf
...
################################写入配置文件################################
install_config() {
    wget -q -O /usr/local/etc/sing-box/config.json https://raw.githubusercontent.com/Jimmyzxk/LinuxScripts/main/AIO/Configs/brutal/singbox/brutal_singbox_config.json
...
outbounds_setting() {
    ...
    white "开始生成出站节点配置..."
    wget -q -O /usr/local/etc/sing-box/outbounds.json https://raw.githubusercontent.com/Jimmyzxk/LinuxScripts/main/AIO/Configs/brutal/singbox/outbounds.json
    ...
    wget -q -O /usr/local/etc/sing-box/vless.txt https://raw.githubusercontent.com/Jimmyzxk/LinuxScripts/main/AIO/Configs/brutal/singbox/vless.txt
